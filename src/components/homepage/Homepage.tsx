...
const Homepage: React.FC<HomepageProps> = ({}) => {
	return (
		<>
			<Helmet
				title={"Josiah Eakle | Full Stack Developer"}
				htmlAttributes={{
					lang: "en",
				}}
			>
				<meta
					name="description"
					content={
						"Hi, I'm Josiah and I create full stack applications using React, Node TypeScript and an array of Content Managment Solutions."
					}
				/>
			</Helmet>
				...
				<ProjectsSection
					projects={[
						...
						},
						{
							...
							myRole: [
								"Styled app with CSS.",
								"Used React to implement the UI",
							],
							techStack: ["React"],
